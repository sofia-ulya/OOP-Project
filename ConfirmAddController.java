 ...
 * @author user
 */
public class ConfirmAddController implements Initializable {
    ...
    private void handleAddButton(ActionEvent event) throws IOException {
        ...
        nextWindow.show();
        Student.stu.setAddSubject(codeSub.getItems(), subSub.getItems(), credSub.getItems());
    }
